...
if __name__ == '__main__':
    ...
    model.add(Dense(2048, activation="relu", kernel_initializer='glorot_normal', bias_initializer='zeros', input_dim=1248))
    ...
    file_train = "../t_data/train_format_input_notime/t_train_format_300embedding_lapless.csv"
    file_tune = "../t_data/tune_format_input_notime/t_tune_format_300embedding.csv"
    ...
    model.save('./dnn_version/notime_twitter_dnn_trained_300dim_lapless_ver1.h5')
    print("=============================StartTuning=====================================")
