...
def result_for_topk(timelist,time_dict,time_user_dict,user_visit_already,u_dict,p_dict,userlist,poilist):
    my_dnn_model = load_model("./dnn_version/gowalla_dnn_trained_300dim_ver1.h5")
    k = 50      # Top_K推荐
    for i in timelist:
        ...
        for j in range(size):
            ...
            topk_pois = []
        file_out = open("../g_data/test/recommendation/ver1/300result_{0}time.txt".format(i),"w",encoding="utf-8")
...
if __name__ == '__main__':
    ...
    file_train_user_visit = open("../g_data/train/g_train_user_visit.txt","r",encoding="utf-8")
    ...
    file_user = open("../g_data/embeddings/user/300user_embedding.csv","r",encoding="utf-8")
    file_poi = open("../g_data/embeddings/poi/300poi_embedding.csv","r",encoding="utf-8")
