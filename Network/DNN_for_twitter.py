...
if __name__ == '__main__':
    ...
    # model.add(BatchNormalization())
    model.add(Dense(32, activation="relu", kernel_initializer='glorot_normal', bias_initializer='zeros', kernel_regularizer=regularizers.l2(0.01)))
    model.add(BatchNormalization())
    model.add(Dropout(0.5))
    ...
    file_train = "../t_data/train_format_input/t_train_format_300embedding.csv"
    file_tune = "../t_data/tune_format_input/t_tune_format_300embedding.csv"
    ...
    model.save('./dnn_version/twitter_dnn_trained_300dim_ver2.h5')
    print("=============================StartTuning=====================================")
