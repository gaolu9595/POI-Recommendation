...
if __name__ == '__main__':
    ...
    file_train = "../f_data/train_format_input/neighbor_norm/f_train_format_300embedding.csv"
    file_tune = "../f_data/tune_format_input/neighbor_norm/f_tune_format_300embedding.csv"
    ...
    checkpoint = callbacks.ModelCheckpoint("./dnn_version/f_neighbor_norm/weights.{epoch:02d}-{val_loss:.2f}.hdf5", monitor="val_loss", verbose=1, save_best_only=True, save_weights_only=False, mode="auto", period=1)
