...
if __name__ == '__main__':
    ...
    file_train = "../g_data/train_format_input/g_train_format_300embedding.csv"
    file_tune = "../g_data/tune_format_input/g_tune_format_300embedding.csv"
    ...
    model.save('./dnn_version/gowalla_dnn_trained_300dim_ver1.h5')
    print("=============================StartTuning=====================================")
