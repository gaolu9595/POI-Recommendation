...
file_in = "../f_data/matrix/f_train_time_sim_matrix.txt"
file_out = "../f_data/matrix/f_smooth_train_time_sim_matrix.txt"

# file_in = "../g_data/matrix/g_train_time_sim_matrix.txt"
# file_out = "../g_data/matrix/g_smooth_train_time_sim_matrix.txt"

# file_in = "../t_data/matrix/t_train_time_sim_matrix.txt"
# file_out = "../t_data/matrix/t_smooth_train_time_sim_matrix.txt"
...
plt.legend()
plt.draw()
# plt.savefig("./time_sim_pic/twitter_time_sim_pic_total",dpi=600)
# plt.savefig("./time_sim_pic/gowalla_time_sim_pic_total",dpi=600)
plt.savefig("./time_sim_pic/foursquare_time_sim_pic_total",dpi=600)
plt.show()
