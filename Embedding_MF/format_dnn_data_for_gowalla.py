...
def format_train_checkins(file_train, u_dict, p_dict, time_dict, user_visit_dict, train_poilist, file_out, emb_dim):
    ...
    j = 0
    # 304047*2
    pos_emb_matrix = np.zeros((emb_dim,361250))
    neg_emb_matrix = np.zeros((emb_dim,361250))
...
def format_tune_checkins(file_tune, u_dict, p_dict, time_dict, file_out, emb_dim):
    ...
    j = 0
    # 33359
    emb_matrix = np.zeros((emb_dim, 33605))
...
if __name__ == '__main__':
    ...
    file_user_visit = open("../g_data/train/g_train_user_visit.txt","r",encoding="utf-8")
    ...
    for i in dim_list:
        ...
        # file_train = open("../g_data/g_train_set.txt","r",encoding="utf-8")
        file_tune = open("../g_data/g_tune_set.txt","r",encoding="utf-8")
        file_user = open("../g_data/embeddings/user/{0}user_embedding.csv".format(i),"r",encoding="utf-8")
        file_poi = open("../g_data/embeddings/poi/{0}poi_embedding.csv".format(i),"r",encoding="utf-8")
        # file_out1 = open("../g_data/train_format_input/g_train_format_{0}embedding.csv".format(i),"w",encoding="utf-8")
        file_out2 = open("../g_data/tune_format_input/g_tune_format_{0}embedding.csv".format(i),"w",encoding="utf-8")
