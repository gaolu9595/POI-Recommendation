# Twitter数据集里不包含用户关系，因此user的embedding只有其访问pois的期望
...
def createUserEmbedding(user_visit_dict,poi_rank_dict,userlist,file_train_poi_embedding,file_out):
    ...
    total_feature_matrix = np.insert(user_average_pois, 0, values=userlist, axis=0)
