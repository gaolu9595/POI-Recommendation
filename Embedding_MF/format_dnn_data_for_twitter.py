...
if __name__ == '__main__':
    ...
    for i in dim_list:
        ...
        file_out1 = open("../t_data/train_format_input/t_train_format_{0}embedding.csv".format(i),"w",encoding="utf-8")
        # file_out2 = open("../t_data/tune_format_input/t_tune_format_{0}embedding.csv".format(i),"w",encoding="utf-8")
