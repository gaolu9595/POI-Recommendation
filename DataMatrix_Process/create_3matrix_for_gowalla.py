...
file = "../g_data/g_train_set.txt"
#从总geo列表得到将要构建的两个矩阵的维数
file_total_geo = "../g_data/valid_total/g_valid_total_poi_geo.txt"

#以下都是要生成的文件
file_user_poi_dict = "../g_data/train/g_train_user_visit.txt"
file_time_poi_dict = "../g_data/train/g_train_visit_time.txt"
file_geo_poi_dict = "../g_data/train/g_train_poi_geo.txt"
